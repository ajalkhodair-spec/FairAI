...
|---|---|---|---|---|
| BLK-001 | V2 Groth16 | Installed `circom` is 0.5.46; `FairnessEligibilityV2.circom` requires 2.1.6. The pinned V2 R1CS/WASM/ZKey do not exist. | Direct V2 proof generation, verification latency, and pairing-verifier gas cannot be measured. | Install the pinned Circom 2.1.6 binary, provide the checksum-pinned Powers of Tau file, regenerate artifacts, and run the negative binding suite. |
