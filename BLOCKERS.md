...
| BLK-002 | Resolved bounded | Two-peer IPFS | Two native Kubo 0.29.0 peers completed 30-repeat cold/warm/concurrency measurements and strict B2/B4/B7 runs at 5/10 clients. Docker socket access was not required. | Process outage/recovery, separate pin latency, WAN, Docker Compose, and multi-host measurements remain limitations rather than completed evidence. |
